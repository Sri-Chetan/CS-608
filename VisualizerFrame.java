...
public class VisualizerFrame extends JFrame {
    ...
    private final String[] Sorts = {"Bubble", "Selection"};
    ...
    public void reDrawArray(Integer[] x, int y, int z, int w) {
        for (int i = 0; i < SortingVisualizer.sortDataCount; i++) {
            if (i == y || i == z || i == w) {
            ...
            squarePanels[i].setPreferredSize(new Dimension(SortingVisualizer.blockWidth, x[i] * sizeModifier));
        }
        repaint();
        validate();
        try {
